...
const NEUTRAL = {
  ...
  projectMeta: [
    { id: "p1", year: "2025", href: "https://www.tvijverhof.be/", featured: true, tags: ["Design", "Web"],
      ...
      shots: [
        { src: "/projects/p1/home.png", label: "Home" },
        { src: "/projects/p1/menu.png", label: "Menu" },
        { src: "/projects/p1/wijnen.png", label: "Wines" },
        { src: "/projects/p1/dessert.png", label: "Dessert" },
        { src: "/projects/p1/gallerij.png", label: "Gallery" },
        { src: "/projects/p1/rouwmaaltijden.png", label: "Memorial meals" },
        { src: "/projects/p1/contact.png", label: "Reservation & contact" },
      ] },
    { id: "p2", year: "2021", href: "https://www.uitvaartbegeleidingstefaan.be/", tags: ["Design", "Web"],
      cover: "/projects/p2/cover.png",
      shots: [
        { src: "/projects/p2/home.png", label: "Home" },
        { src: "/projects/p2/voorafregeling.png", label: "Pre-arrangement" },
        { src: "/projects/p2/uitvaartzorg-uitvaartplechtigheid.png", label: "Funeral ceremony" },
        { src: "/projects/p2/uitvaartzorg-meld-een-overlijden.png", label: "Report a death" },
        { src: "/projects/p2/aula.png", label: "Aula" },
        { src: "/projects/p2/funerarium.png", label: "Funerarium" },
        { src: "/projects/p2/rouwtoebehoren.png", label: "Mourning accessories" },
        { src: "/projects/p2/rondleiding.png", label: "Guided tour" },
      ] },
  ],
...
const NL = {
  ...
  location: "België",
  ui: {
    navHome: "Home", navWork: "Werk", navAbout: "Over mij", navContact: "Contact",
...
const FR = {
  ...
  location: "Belgique",
  ui: {
    navHome: "Accueil", navWork: "Projets", navAbout: "À propos", navContact: "Contact",
